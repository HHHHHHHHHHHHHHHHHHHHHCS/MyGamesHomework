...
namespace Games_103_3
{
	public class FVM : MonoBehaviour
	{
		...
		private void Start()
		{
			...
			{
				string[] Strings = eleText.text.Split(new char[] { ' ', '\t', '\r', '\n' },
			...
			{
				string fileContent = nodeText.text;
		...
		private Matrix4x4 Build_Edge_Matrix(int tet)
		{
		...
		private void UpdateVert(float dt)
		{
			//Add Gravity.
			for (int i = 0; i < number; i++)
			{
